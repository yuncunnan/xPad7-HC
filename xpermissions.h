...
#define FA_XIONGCHUAN 		((GUANGDONG << 8) | 0x00AA)		// 熊创（显示加速度和加加速调整框）
#define FA_JINYI            ((GUANGDONG << 8) | 0x00AB)		// 金益（要求物理按键控制更改：单臂程序参考双臂——左右轴2控制旋转轴；上下轴2控制倒角，伺服轴）
...
// 定义当前厂商 ID
#define FACTORY				FA_JINYI//FA_SINROBOT_CN//FA_XIONGCHUAN//FA_TIANRUI//FA_TIANRUI//FA_MIDEA//FA_TIANRUI//FA_XIONGCHUANG//FA_BEISHITE_CN//FA_SINROBOT//FA_VICTOR_SPECIAL//FA_SINROBOT_CN//FA_BEISHITE_CN//FA_VICTOR_SPECIAL
