...
// 定义当前厂商 ID
#define FACTORY				FA_XIONGCHUAN//FA_TIANRUI//FA_TIANRUI//FA_MIDEA//FA_TIANRUI//FA_XIONGCHUANG//FA_BEISHITE_CN//FA_SINROBOT//FA_VICTOR_SPECIAL//FA_SINROBOT_CN//FA_BEISHITE_CN//FA_VICTOR_SPECIAL
