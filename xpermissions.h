...
// 定义当前厂商 ID
#define FACTORY				FA_VICTOR_SPECIAL//FA_SINROBOT_CN//FA_XIONGCHUANG//FA_BEISHITE_CN//FA_SINROBOT//FA_VICTOR_SPECIAL//FA_SINROBOT_CN//FA_BEISHITE_CN//FA_VICTOR_SPECIAL
