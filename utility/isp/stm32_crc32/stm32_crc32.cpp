...
//width_t STM32_CRC32::m_crcTable[256];
...
STM32_CRC32::STM32_CRC32(QObject *parent) :
    QObject(parent)
{
}

void STM32_CRC32::GenCRCTable(void)
{
	quint32 remainder;
	quint32 dividend;
    int bit;
...
quint32 STM32_CRC32::stm32crc32(quint32 * message, unsigned int nWords, quint32 remainder)
{
    unsigned int offset;
    unsigned char byte;
    ...
    for( offset = 0; offset < nWords; offset++)
    {
        ...
        remainder = m_crcTable[byte] ^ (remainder << 8);
