...
#include "ui_formbtnpos.h"
#include "servoalias.h"
#include "xstringresource.h"
#include "xmessagebox.h"

FormBtnPos::FormBtnPos(QWidget *parent) : QWidget(parent), ui(new Ui::FormBtnPos)
{
    // 初始化界面
    ui->setupUi(this);
    retranslateUi();
...
FormBtnPos::~FormBtnPos()
{
    delete ui;
}

void FormBtnPos::changeEvent(QEvent *e)
{
...
bool FormBtnPos::EnterForm(void)
{
    init();
    UpdateWidgetState();
    show();
...
void FormBtnPos::retranslateUi(void)
{
...
quint32 FormBtnPos::GetPaHorSpeed()
{
    return ui->BoxPaHorSpeed->value();
}
quint32 FormBtnPos::GetPaVerSpeed()
{
    return ui->BoxPaVerSpeed->value();
}
quint32 FormBtnPos::GetTrvSpeed()
{
    return ui->BoxTrvSpeed->value();
}
quint32 FormBtnPos::GetRaHorSpeed()
{
    return ui->BoxRaHorSpeed->value();
}
quint32 FormBtnPos::GetRaVerSpeed()
{
    return ui->BoxRaVerSpeed->value();
}
quint32 FormBtnPos::GetOtherSpeed()
{
    return ui->BoxOtherSpeed->value();
}

int FormBtnPos::GetAxes()
{
    int ret = 0;
...
// 输入正臂引拔位置信号槽
void FormBtnPos::inputPaHor(void)
{
...
// 输入正臂上下位置信号槽
void FormBtnPos::inputPaVer(void)
{
    int type = POS_TYPE_POINT;
	DialogNumberPad numberPad;
	double value;
...
// 输入横行位置信号槽
void FormBtnPos::inputTravel(void)
{
    int type = POS_TYPE_POINT;
	DialogNumberPad numberPad;
	double value;
...
// 输入副臂引拔位置信号槽
void FormBtnPos::inputRaHor(void)
{
    int type = POS_TYPE_POINT;
	DialogNumberPad numberPad;
	double value;
...
// 输入副臂上下位置信号槽
void FormBtnPos::inputRaVer(void)
{
    int type = POS_TYPE_POINT;
	DialogNumberPad numberPad;
	double value;
...
// 输入扩展位置信号槽
void FormBtnPos::inputOther(void)
{
    int type = POS_TYPE_POINT;
	DialogNumberPad numberPad;
	double value;
...
void FormBtnPos::UpdateWidgetState()
{
    if (CMBProtocol::GetTemplateUse())
    {
    ...
    {
        ui->radioPaHor->setEnabled(!CMBProtocol::GetPaHorNotUse());
        ui->radioRaHor->setEnabled(CMBProtocol::GetRhorSrvUse() && (((CMBProtocol::GetServoNotExist() >> AXES_IDX_B) & 1) == 0));
        ui->radioRaVer->setEnabled(CMBProtocol::GetRverSrvUse() && (((CMBProtocol::GetServoNotExist() >> AXES_IDX_A) & 1) == 0));
        ui->radioOther->setEnabled(CMBProtocol::GetExtSrvUse() && (((CMBProtocol::GetServoNotExist() >> AXES_IDX_C) & 1) == 0));
        ui->radioRaHor->setEnabled(CMBProtocol::GetRhorSrvUse());
        ui->radioRaVer->setEnabled(CMBProtocol::GetRverSrvUse());
        ui->radioOther->setEnabled(CMBProtocol::GetExtSrvUse());
...
void FormBtnPos::inputPaVerSpeed(void)
{
    DialogNumberPad numberPad;
    int value;
...
void FormBtnPos::inputTrvSpeed(void)
{
    DialogNumberPad numberPad;
    int value;
...
void FormBtnPos::inputRaHorSpeed(void)
{
    DialogNumberPad numberPad;
    int value;
...
void FormBtnPos::inputRaVerSpeed(void)
{
    DialogNumberPad numberPad;
    int value;
...
void FormBtnPos::inputOtherSpeed(void)
{
    DialogNumberPad numberPad;
    int value;
...
void FormBtnPos::inputPaHorDelay(void)
{
    DialogNumberPad numberPad;
    double value;
...
void FormBtnPos::inputPaVerDelay(void)
{
    DialogNumberPad numberPad;
    double value;
...
void FormBtnPos::inputTrvDelay(void)
{
    DialogNumberPad numberPad;
    double value;
...
void FormBtnPos::inputRaHorDelay(void)
{
    DialogNumberPad numberPad;
    double value;
...
void FormBtnPos::inputRaVerDelay(void)
{
    DialogNumberPad numberPad;
    double value;
...
void FormBtnPos::inputOtherDelay(void)
{
    DialogNumberPad numberPad;
    double value;
...
void FormBtnPos::syncPaHorPos(void)
{
    m_x_pos = CMBProtocol::GetPaHorPos();
    ui->BoxPaHor->setText(QString::number((double)m_x_pos / 100.00));
}
void FormBtnPos::syncPaVerPos(void)
{
    m_y_pos = CMBProtocol::GetPaVerPos();
    ui->BoxPaVer->setText(QString::number((double)m_y_pos / 100.00));
}
void FormBtnPos::syncTrvPos(void)
{
    m_z_pos = CMBProtocol::GetTravelPos();
    ui->BoxTrv->setText(QString::number((double)m_z_pos / 100.00));
}
void FormBtnPos::syncRaHorPos(void)
{
    m_b_pos = CMBProtocol::GetRaHorPos();
    ui->BoxRaHor->setText(QString::number((double)m_b_pos / 100.00));
}
void FormBtnPos::syncRaVerPos(void)
{
    m_a_pos = CMBProtocol::GetRaVerPos();
    ui->BoxRaVer->setText(QString::number((double)m_a_pos / 100.00));
}
void FormBtnPos::syncExtPos(void)
{
