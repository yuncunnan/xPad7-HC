...
void xStringResource::initAlarmRes(void)
{
    ...
    if ((CMBProtocol::GetSysType() == ROBOTARM_TYPE_SIXSV_PAD_E4) || (CMBProtocol::GetSysType() == ROBOTARM_TYPE_SIXSV_PAD_F4))
    {
   ...
   #elif ((FACTORY == FA_XIONGCHUANG) || (FACTORY == FA_VICTOR) || (FACTORY == FA_KEHUI) || (FACTORY == FA_WEILIHE) || (FACTORY == FA_SIGMA) ||  (FACTORY == FA_SINROBOT_CN) || (FACTORY == FA_BEISHITE_CN))
   ...
   #else
           << tr("[027] %1轴位置不在安全区域，禁止注塑机关模。").arg(GetServoName(AXIS_IDX_RVER))
           << tr("[028] %1轴位置不在安全区域，禁止注塑机关模。").arg(GetServoName(AXIS_IDX_PHOR))
#endif
        << tr("[029] 在模内下位倒角不安全。")
           ...
           << tr("[031] %1轴没有原点信号。").arg(GetServoName(AXIS_IDX_RVER))
   #else
           << tr("[030] %1轴没有原点信号。").arg(GetServoName(AXIS_IDX_PHOR))
           << tr("[031] %1轴没有原点信号。").arg(GetServoName(AXIS_IDX_RVER))
   #endif
        << tr("[032]")
        << tr("[033]")
...
#elif (FACTORY == FA_GH)
        << tr("[037] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[038] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[039] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[040]")
        << tr("[041]")
        << tr("[042]")
        << tr("[043] 没有开模完信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[044] 没有中板模信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[045] %1轴不在安全区内，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_PVER))
        << tr("[046]")
        << tr("[047] 模内超出安全区，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
#elif ((FACTORY == FA_KINGROBOT) || (FACTORY == FA_BEISHITE) || (FACTORY == FA_AIERFA))
        << tr("[037] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_PHOR))
        ...
        << tr("[047] 模内超出安全区，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR));
#else
        << tr("[037] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_PVER))
        << tr("[038] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_PVER))
        << tr("[039] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[040]")
        << tr("[041]")
        << tr("[042]")
        << tr("[043] 没有开模完信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[044] 没有中板模信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[045] %1轴不在安全区内，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[046]")
		<< tr("[047] 模内超出安全区，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
#endif
        << tr("[048]")
        ...
        << tr("[059] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[060] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[061] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[062] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[063] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[064] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[065] %1轴位置在模内安全区域内，但没有检测到模内安全区域信号。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[066] %1轴位置在模外安全区域内，但没有检测到模外安全区域信号。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[067] %1轴位置不在安全区内，%2轴运动不安全。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[068] %1轴位置不在安全区内，%1轴运动不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[069] %1轴位置在上位待机安全区内，但没有上位安全区信号。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[070] %1轴位置在上位待机安全区内，但没有上位安全区信号。").arg(GetServoName(AXIS_IDX_RVER))
#else
        << tr("[059] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[060] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[061] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[062] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[063] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[064] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[065] %1轴位置在模内安全区域内，但没有检测到模内安全区域信号。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[066] %1轴位置在模外安全区域内，但没有检测到模外安全区域信号。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[067] %1轴位置不在安全区内，%2轴运动不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[068] %1轴位置不在安全区内，%1轴运动不安全。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[069] %1轴位置在上位待机安全区内，但没有上位安全区信号。").arg(GetServoName(AXIS_IDX_PHOR))
		<< tr("[070] %1轴位置在上位待机安全区内，但没有上位安全区信号。").arg(GetServoName(AXIS_IDX_RVER))
#endif
        << tr("[071]")
       ...
       << tr("[083] 主臂上下伺服没有就绪")
       << tr("[084] 等待开模动作超时。")
       << tr("[085] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_PHOR))
       << tr("[086] 横行伺服没有就绪")
       << tr("[087] 横行伺服不在线")
       << tr("[088] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_RVER))
       << tr("[089] 副臂上下伺服没有就绪 ")
       ...
       << tr("[080] 主臂引拔伺服没有就绪")
       << tr("[081] 主臂引拔伺服不在线")
       << tr("[082] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_PHOR))
       << tr("[083] 主臂上下伺服没有就绪")
       << tr("[084] 等待开模动作超时。")
       << tr("[085] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_PVER))
       << tr("[086] 横行伺服没有就绪")
       << tr("[087] 横行伺服不在线")
       << tr("[088] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_RVER))
       << tr("[089] 副臂上下伺服没有就绪 ")
...
#elif ((FACTORY == FA_XIONGCHUANG) || (FACTORY == FA_VICTOR) || (FACTORY == FA_KEHUI) || (FACTORY == FA_WEILIHE) || (FACTORY == FA_SIGMA) ||  (FACTORY == FA_SINROBOT_CN) || (FACTORY == FA_BEISHITE_CN))
        << tr("[100] %1轴在模内区域，注塑机开模完信号消失。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[101] %1轴在模内区域，注塑机中板模信号消失。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[102] %1轴在模内区域，注塑机开模完信号消失。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[103] %1轴在模内区域，注塑机中板模信号消失。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[104] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[105] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[106] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[107] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PVER))
       ...
       << tr("[106] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PVER))
       << tr("[107] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PVER))
       << tr("[108] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
       << tr("[109] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PHOR))
       << tr("[110] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_RVER))
       << tr("[111] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_RVER))
       << tr("[112] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_RHOR))
       << tr("[113] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_RHOR))
       ...
       << tr("[115] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_EXT))
        ...
        << tr("[103]%1轴在模内区域，注塑机中板模信号消失。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[104]%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[105]%1轴伺服运行到负极限。").arg(GetServoName(GetServoNameAXIS_IDX_PHOR)
        << tr("[106]%1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[107]%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[108]%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[109]%1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PHOR))
        ...
        << tr("[100]%1轴在模内区域，注塑机开模完信号消失。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[101]%1轴在模内区域，注塑机中板模信号消失。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[102]%1轴在模内区域，注塑机开模完信号消失。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[103]%1轴在模内区域，注塑机中板模信号消失。").arg(GetServoName(AXIS_IDX_PHOR))
		<< tr("[104]%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
		<< tr("[105]%1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[106]%1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[107]%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PVER))
...
#elif (FACTORY == FA_GH)
        << tr("[124] 系统设置倒角垂直时，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[125] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#elif ((FACTORY == FA_KINGROBOT) || (FACTORY == FA_BEISHITE) || (FACTORY == FA_AIERFA))
        << tr("[124] 系统设置倒角垂直时，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        ...
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#else
        << tr("[124] 系统设置倒角垂直时，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[125] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#endif
        << tr("[127]")
       ...
       <<tr("[130] %1轴和%2轴位置冲突。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_RHOR))
...
#elif (FACTORY == FA_GH)
        << tr("[134] %1轴入模不安全,没有开模完信号(模外待机)。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[135] %1轴入模不安全,没有中板模信号(模外待机)。").arg(GetServoName(AXIS_IDX_PHOR))
#elif ((FACTORY == FA_KINGROBOT) || (FACTORY == FA_BEISHITE) || (FACTORY == FA_AIERFA))
        << tr("[134] %1轴入模不安全,没有开模完信号(模外待机)。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[135] %1轴入模不安全,没有中板模信号(模外待机)。").arg(GetServoName(AXIS_IDX_PHOR))
#else
        << tr("[134] %1轴入模不安全,没有开模完信号(模外待机)。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[135] %1轴入模不安全,没有中板模信号(模外待机)。").arg(GetServoName(AXIS_IDX_PVER))
#endif
        << tr("[136] 无效的气动副臂动作。")
        << tr("[137] 气动副臂下行但电眼不亮。")
        << tr("[138] 气动副臂下行但上行电眼亮。")
...
#else
        << tr("[144] 副臂气动在模内下位，塑机开模中间信号消失。")
        << tr("[145] %1轴模内下位，塑机开模中间信号消失。").arg(GetServoName(AXIS_IDX_PHOR))
#endif
        << tr("[146] 连续路径中的指令太多。")
        << tr("[147]")
        << tr("[148]")
        ...
        << tr("[177] %1轴不在安全区，手臂横行不安全。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[178] %1轴运行不安全，不能超过模内安全区。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[179] 手臂横行不安全，%1轴不在安全区。").arg(GetServoName(AXIS_IDX_PHOR))
#else
        << tr("[167] %1轴不在模内安全区，手臂下行不安全。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[168] %1轴不在模内安全区，手臂下行不安全。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[169] %1轴不在上位，手臂倒角不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[170] %1轴不在上位，手臂旋转不安全。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[171] %1轴不在安全位，手臂横行不安全。")
        << tr("[172] 手臂倒角不安全,不能超过模内安全区。")
        << tr("[173] 手臂旋转不安全,不能超过模内安全区。")
        << tr("[174] %1轴位置超过软件行程。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[175] %1轴位置超过软件行程。").arg(GetServoName(AXIS_IDX_RHOR))
        ...
        << tr("[184] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[185] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[186] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[187] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[188] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[189] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[190] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[191] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[192] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[193] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[194] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[195] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_EXT))
#elif ((FACTORY == FA_KINGROBOT) || (FACTORY == FA_BEISHITE) || (FACTORY == FA_AIERFA))
...
#else
        << tr("[184] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[185] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[186] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[187] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[188] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[189] %1轴不支持的绝对值编码器。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[190] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[191] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[192] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[193] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[194] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[195] %1轴绝对值编码器通讯错误。").arg(GetServoName(AXIS_IDX_EXT))
#endif
...
#elif (FACTORY == FA_GH)
        << tr("[199] %1轴模内和模外安全区有重叠。").arg(GetServoName(AXIS_IDX_PHOR))
#elif ((FACTORY == FA_KINGROBOT) || (FACTORY == FA_BEISHITE) || (FACTORY == FA_AIERFA))
        << tr("[199] %1轴模内和模外安全区有重叠。").arg(GetServoName(AXIS_IDX_PHOR))
#else
        << tr("[199] %1轴模内和模外安全区有重叠。").arg(GetServoName(AXIS_IDX_PVER))
#endif
        << tr("[200] 伺服未到达目标位置")
        << tr("[201]")
        << tr("[202]")
        ...
        << tr("[213] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[214] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[215] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[216] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[217] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[218] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[219]")
...
#else
        << tr("[213] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[214] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[215] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[216] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[217] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[218] %1轴绝对值编码器电池电压低。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[219]")
        ...
        else if (CMBProtocol::GetSysType() == ROBOTARM_TYPE_SIXSV_PAD_YZ)
    {
        ...
        << tr("[026] 系统正在运行，不能改变系统的工作状态。")
#if (FACTORY == FA_YIDAO)
        << tr("[027] %1轴位置不在安全区域，禁止压铸机关模。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[028] %1轴位置不在安全区域，禁止压铸机关模。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[029] 系统设置中禁止[模内倒角]，在模内执行主臂或副臂气动倒角动作不安全。")
        << tr("[030] %1轴没有原点信号。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[031] %1轴没有原点信号。").arg(GetServoName(AXIS_IDX_TRV))
#else
...
#else
        << tr("[037] 取件臂不在上位，横行动作不安全。")
        << tr("[038] 喷雾臂不在上位，横行动作不安全。")
        << tr("[039] %1轴不在上位，前后%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR))
#endif
        << tr("[040]")
#if (FACTORY == FA_YIDAO)
        ...
        << tr("[057] 系统工作状态错误。")
#if (FACTORY == FA_YIDAO)
        << tr("[058] 正臂或副臂气动倒角水平时，禁止在模内下行；请检查系统参数设置。")
        << tr("[059] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[060] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[061] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_TRV))
        << tr("[062] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[063] %1轴位置超出了软件行程。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[064] %1轴位置超出了对应的软件行程。").arg(GetServoName(AXIS_IDX_EXT))
        ...
        << tr("[068] %1轴不在安全区内，%2轴运动不安全。").arg(GetServoName(AXIS_IDX_TRV)).arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[069] %1轴位置在上位待机安全区内，但没有上位安全区信号。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[070] %1轴位置在上位待机安全区内，但没有上位安全区信号。").arg(GetServoName(AXIS_IDX_RVER))
#else
        ...
        << tr("[091] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_RHOR))
#else
        << tr("[075] 倒角水平，但没有检测到水平到位信号。")
        << tr("[076] 倒角水平，但检测到垂直到位信号。")
        << tr("[077] 倒角垂直，但没有检测到垂直到位信号。")
        << tr("[078] 倒角垂直，但检测到水平到位信号。")
        << tr("[079] 前后%1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[080] 主臂引拔伺服没有就绪")
        << tr("[081] 主臂引拔伺服不在线")
        << tr("[082] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[083] 主臂上下伺服没有就绪")
        << tr("[084] 等待开模超时。")
        << tr("[085] 横行%1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_TRV))
        << tr("[086] 横行伺服没有就绪")
        << tr("[087] 横行伺服不在线")
        << tr("[088] 喷雾%1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[089] 副臂上下伺服没有就绪 ")
        << tr("[090] 副臂上下伺服不在线")
        << tr("[091] %1轴伺服报警，请检查伺服驱动器。").arg(GetServoName(AXIS_IDX_RHOR))
#endif
        ...
        << tr("[095] 扩展伺服没有就绪 ")
        << tr("[096] 扩展伺服不在线")
        << tr("[097] 压铸机紧急停止，请检查压铸机。")
        << tr("[098] 机械手紧急停止，请检查机械手。")
#if (FACTORY == FA_YIDAO)
        << tr("[099] 气源气压过低，请检查气源压力。")
        << tr("[100] %1轴在模内区域，压铸机开模完信号消失。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[101] %1轴在模内区域，压铸机中板模信号消失。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[102] %1轴在模内区域，压铸机开模完信号消失。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[103] %1轴在模内区域，压铸机中板模信号消失。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[104] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[105] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[106] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[107] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PVER))
...
#else
        << tr("[099] 油缸缺油，请检查油缸。")
        << tr("[100] 喷雾臂在模内区域，压铸机开模完成信号消失。")
        << tr("[101] 喷雾臂在模内区域，压铸机开中板模确认信号消失。")
        << tr("[102] 取件臂在模内区域，压铸机开模完成信号消失。")
        << tr("[103] 取件臂在模内区域，压铸机开中板模确认信号消失。")
        << tr("[104] 前后%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[105] 前后%1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PHOR))
        << tr("[106] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[107] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[108] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_TRV))
        << tr("[109] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_TRV))
        << tr("[110] 喷雾%1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[111] 喷雾%1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[112] %1轴伺服运行到负极限。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[113] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_RHOR))
#endif
        << tr("[114] %1轴伺服运行到正极限。").arg(GetServoName(AXIS_IDX_EXT))
        ...
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#else
        << tr("[124] 当前系统设置取件臂或喷雾臂倒角垂直不允许机械手横行。")
        << tr("[125] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RHOR)).arg(GetServoName(AXIS_IDX_PVER))
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#endif
        << tr("[127]")
...
#else
        << tr("[134] 横行X入模不安全,没有开模完信号(模外待机)。")
        << tr("[135] 横行X入模不安全,没有中板模确认信号(模外待机)。")
        << tr("[136] 无效的气动喷雾臂动作。")
        << tr("[137] 喷雾臂下行但电眼不亮。")
        << tr("[138] 喷雾臂下行但上行电眼亮。")
        << tr("[139] 喷雾臂上行但电眼不亮。")
        << tr("[140] 喷雾臂上行但下行电眼亮。")
        << tr("[141] 横行%1轴不在安全区内，喷雾臂气动下行不安全。").arg(GetServoName(AXIS_IDX_TRV))
        << tr("[142] 模内没有开模完信号，喷雾臂下行不安全。")
        << tr("[143] 模内没有中板模信号，喷雾臂下行不安全。")
        << tr("[144] 喷雾臂在模内没有开模中间信号。")
        << tr("[145] 取件臂在模内没有开模中间信号。")
#endif
        << tr("[146] 连续路径太多。")
        << tr("[147]")
        << tr("[148]")
        ...
        << tr("[199] %1轴模内和模外安全区有重叠。").arg(GetServoName(AXIS_IDX_TRV))
#else
        << tr("[199] 横行%1轴模内和模外安全区有重叠。").arg(GetServoName(AXIS_IDX_TRV))
#endif
        << tr("[200] 伺服未到达目标位置")
        << tr("[201]")
        << tr("[202]")
        ...
        << tr("[219]")
        << tr("[220] %1轴不安全,不能超过横行时安全区(横行当前不在安全区)。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[221] %1轴轴不安全,不能超过横行时安全区(横行当前不在安全区)。").arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[222] %1轴不安全,不能超过横行时安全区(横行当前不在安全区)。").arg(GetServoName(AXIS_IDX_EXT))
        << tr("[223] %1轴不安全,不能超过横行时安全区(横行当前不在安全区)。").arg(GetServoName(AXIS_IDX_PHOR))
#else
    ...
    else
    {
        ...
        << tr("[037] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_TRV))
        << tr("[038] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_TRV))
        << tr("[039] %1轴不在上位，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_PVER))
        << tr("[040] ")
        << tr("[041] 没有开模完信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[042] 没有中板模信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER))
        << tr("[043] 没有开模完信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[044] 没有中板模信号，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER))
        << tr("[045] %1轴不在安全区内，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_TRV)).arg(GetServoName(AXIS_IDX_PVER))
        << tr("[046] %1轴不在安全区内，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_TRV)).arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_RVER))
        << tr("[047] %1轴运行不安全，超出模内安全区。")
#elif (FACTORY == FA_GH)
        << tr("[037] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_PVER)).arg(GetServoName(AXIS_IDX_TRV))
        << tr("[038] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_TRV))
        << tr("[039] %1轴不在上位，%1轴运行不安全。").arg(GetServoName(AXIS_IDX_PHOR)).arg(GetServoName(AXIS_IDX_PVER))
        ...
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#elif((FACTORY == FA_SINROBOT_SIDE)|| FACTORY == FA_JIEJIA_SIDE)
        << tr("[124] 系统设置正臂或副臂气动倒角垂直时，上下运行不安全。")
        << tr("[125] %1轴不在上位，%2轴运行不安全。").arg(GetServoName(AXIS_IDX_RVER)).arg(GetServoName(AXIS_IDX_RHOR))
        << tr("[126] %1轴运行不安全，超出模内安全区。").arg(GetServoName(AXIS_IDX_RHOR))
#elif (FACTORY == FA_GH)
        << tr("[124] 系统设置正臂或副臂气动倒角垂直时，横行运行不安全。")
